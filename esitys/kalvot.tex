...
\item Security: integraatio LDAPiin, Acegi(?)
\end{itemize}
\end{frame}
...
\begin{frame}{Konfigurointi}
\begin{itemize}
\item XML-pohjainen, joko kaikki XML-tiedostoissa tai sitten osa
  (skannaukset) XML-tiedostoissa ja annotaatioilla komponentit.
\item Java-pohjainen
\end{itemize}
\end{frame}
